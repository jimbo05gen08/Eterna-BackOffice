              ...
              [ngClass]="{
                'outline outline-primary': selectedSurfaceColor()
                  ...
                  : layoutService.layoutConfig().darkTheme
                    ? surface.name === 'custom-dark-surface'
                    : surface.name === 'slate',
              }"
              [style]="{
...
export class AppConfigurator {
  ...
  constructor() {
    effect(() => {
      const darkTheme = this.layoutService.layoutConfig().darkTheme;
      if (darkTheme) {
  ...
  primaryColors = computed<SurfacesType[]>(() => {
    ...
    if (this.layoutService.layoutConfig().darkTheme) {
      palettes.push({
        name: "custom-dark-primary",
        palette: {
          50: "#f0f9f0",
          100: "#e0f0e0",
          200: "#c0e0c0",
